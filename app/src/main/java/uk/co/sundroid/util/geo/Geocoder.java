...
public class Geocoder {
	...
	private static void setTimeZone(LocationDetails locationDetails, Context context) {
		...
		ArrayList<TimeZoneDetail> possibleTimeZones = TimeZoneResolver.INSTANCE.getPossibleTimeZones(locationDetails.getLocation(), locationDetails.getCountry(), locationDetails.getState());
