                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = 1; i < firstCol; i++) {
                            TableRow datesRow = (TableRow)view.findViewById(id.moonCalDates1);
                            ...
                            TableRow imagesRow = (TableRow)view.findViewById(id.moonCalImages1);
                        ...
                        for (int i = 0; i < 32 && loopCalendar.get(Calendar.MONTH) == month; i++) {
                            ...
                            TableRow datesRow = (TableRow)view.findViewById(view("moonCalDates" + row));
                            TableRow imagesRow = (TableRow)view.findViewById(view("moonCalImages" + row));
